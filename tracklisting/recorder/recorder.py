...
import numpy as np
import pyaudio
from definitions import DEFAULT_FRAMES, CHUNK, RATE, RECORD_SECONDS, EXCERPT_PATH

# PyAudio sample format — kept here to avoid importing pyaudio from definitions.py
